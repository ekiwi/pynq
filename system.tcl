...
################################################################
# DISABLED: this design seems to work in 2017.2 as well as 2017.3
...
proc create_root_design { parentCell } {
  ...
  # Create instance: AxiLiteLoopBack_0, and set properties
  set AxiLiteLoopBack_0 [ create_bd_cell -type ip -vlnv user.org:user:AxiLiteLoopBack:1.0 AxiLiteLoopBack_0 ]

  set_property -dict [ list \
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /AxiLiteLoopBack_0/io]

  # Create instance: AxiLiteReadDifferentConstants_0, and set properties
  set AxiLiteReadDifferentConstants_0 [ create_bd_cell -type ip -vlnv user.org:user:AxiLiteReadDifferentConstants:1.0 AxiLiteReadDifferentConstants_0 ]

  set_property -dict [ list \
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /AxiLiteReadDifferentConstants_0/io]

  # Create instance: AxiLiteReadOneConstant_0, and set properties
  set AxiLiteReadOneConstant_0 [ create_bd_cell -type ip -vlnv user.org:user:AxiLiteReadOneConstant:1.0 AxiLiteReadOneConstant_0 ]
...
CONFIG.C_IRQ_CONNECTION {1} \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M05_AXI [get_bd_intf_pins AxiLiteReadOneConstant_0/io] [get_bd_intf_pins processing_system7_0_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M06_AXI [get_bd_intf_pins AxiLiteReadDifferentConstants_0/io] [get_bd_intf_pins processing_system7_0_axi_periph/M06_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M07_AXI [get_bd_intf_pins AxiLiteLoopBack_0/io] [get_bd_intf_pins processing_system7_0_axi_periph/M07_AXI]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins AxiLiteLoopBack_0/clock] [get_bd_pins AxiLiteReadDifferentConstants_0/clock] [get_bd_pins AxiLiteReadOneConstant_0/clock] [get_bd_pins AxisQueue_0/clock] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins btns_gpio/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/M02_ACLK] [get_bd_pins processing_system7_0_axi_periph/M03_ACLK] [get_bd_pins processing_system7_0_axi_periph/M04_ACLK] [get_bd_pins processing_system7_0_axi_periph/M05_ACLK] [get_bd_pins processing_system7_0_axi_periph/M06_ACLK] [get_bd_pins processing_system7_0_axi_periph/M07_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rgbleds_gpio/s_axi_aclk] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk] [get_bd_pins swsleds_gpio/s_axi_aclk] [get_bd_pins system_interrupts/s_axi_aclk]
  ...
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins AxiLiteLoopBack_0/reset] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins btns_gpio/s_axi_aresetn] [get_bd_pins inv/Op1] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M03_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M04_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M05_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M06_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M07_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rgbleds_gpio/s_axi_aresetn] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn] [get_bd_pins swsleds_gpio/s_axi_aresetn] [get_bd_pins system_interrupts/s_axi_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_reset [get_bd_pins AxiLiteReadDifferentConstants_0/reset] [get_bd_pins AxiLiteReadOneConstant_0/reset] [get_bd_pins rst_processing_system7_0_100M/peripheral_reset]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C20000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AxiLiteLoopBack_0/io/reg0] SEG_AxiLiteLoopBack_0_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AxiLiteReadDifferentConstants_0/io/reg0] SEG_AxiLiteReadDifferentConstants_0_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AxiLiteReadOneConstant_0/io/reg0] SEG_AxiLiteReadOneConstant_0_reg0
